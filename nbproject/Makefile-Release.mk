...
${OBJECTDIR}/lib/old/geometry.o: lib/old/geometry.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/old/geometry.o lib/old/geometry.cc

${OBJECTDIR}/lib/old/predicates.o: lib/old/predicates.cc 
	${MKDIR} -p ${OBJECTDIR}/lib/old
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/old/predicates.o lib/old/predicates.cc
